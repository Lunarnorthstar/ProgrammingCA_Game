...
public class ProjectileDraw : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Vector3 startingPosition = slingshotController.ShotPoint.position;
        Vector3 startingVelocity = slingshotController.ShotPoint.up * slingshotController.BlastPower;
